...
- [x] CHK018 ¿Está especificada la precisión de la fecha del historial (fecha sola o fecha con hora) y su zona horaria? El filtrado por fecha y el orden de los registros dependen de eso. [Gap, §FR-022, §FR-023, §FR-024, §FR-026] → **Resuelto 2026-07-29 (fase de plan)** y **re-resuelto 2026-08-02**: `TEXT` ISO-8601 con milisegundos en la **hora de la librería (UTC-3)**, con el desfase explícito en la cadena; el filtro compara directo, sin conversión (research.md § R6).
